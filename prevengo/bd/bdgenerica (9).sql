...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-05-2015 a las 21:58:45
...
`id` int(3) NOT NULL,
  ...
  `estatus` tinyint(1) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1 COMMENT='empleados que herada de persona';
...
(2, 23364399, 'V', '2015-03-26', 4, NULL, 2, 1, 1, 1),
(5, 18, 'V', '2015-04-06', 5, NULL, 1, 3, 2, 1),
(6, 202020, 'V', '2013-01-08', 5, NULL, 2, 11, 3, 1),
(7, 1279790, 'v', '2015-05-13', 5, NULL, 2, 12, 4, 1),
(8, 3080841, 'v', '2015-05-03', 4, NULL, 1, 18, 2, 1),
(9, 3864789, 'v', '2015-05-20', 4, NULL, 3, 7, 3, 1),
(10, 2199259, 'v', '2015-05-14', 5, NULL, 1, 1, 4, 1);
...
INSERT INTO `ente` (`id`, `nombre`, `tipo`, `parroquia`, `direccion`, `correoente`, `clave`, `codigo`, `telefonoente`, `faxente`, `estatus`) VALUES
(1, 'ente 1', '', 8, '', '', '', '', 0, 0, 1),
(2, 'ente 2', '', 8, '', '', '', '', 0, 0, 1),
(3, 'ente 3', '', 8, '', '', '', '', 123456, 0, 1),
(4, 'ente 4', '', 8, '', '', '', '', 123456, 0, 1);
...
INSERT INTO `menu` (`id`, `text`, `iconCls`, `className`, `controller`, `padre`, `sistema`) VALUES
(1, 'Registros Básicos', '', NULL, '', NULL, 1),
(2, 'Autorización', '', NULL, '', NULL, 1),
(3, 'Reportes', '', NULL, '', NULL, 1),
(4, 'Sesión', '', NULL, '', NULL, 1),
(5, 'Usuario', 'registro1', 'usuario', 'registrar.UsuarioController', 1, 1),
(6, 'Registrar autorización', 'registro1', 'autorizacion', 'registrar.AutorizacionController', 2, 1),
(7, 'Empleados autorizados', 'registro1', 'autorizados', 'consultar.AutorizadosController', 2, 1),
(8, 'Empleado', 'registro1', 'empleado', 'registrar.EmpleadoController', 1, 1),
(9, 'Cambio de clave', 'registro1', 'contrasena', 'registrar.ContrasenaController', 4, 1),
(10, 'Cerrar sesión', 'registro1', NULL, 'login.SalirController', 4, 1),
(11, 'Consultar autorización', 'registro1', 'consultarautorizados', 'consultar.ConsultarAutorizadosController', 2, 1),
(12, 'Autorizaciones procesadas', 'registro1', 'procesadas', 'consultar.ProcesadosController', 2, 1),
(13, 'Listados', 'registro1', 'reportegen', 'reportes.Reportegeneral', 3, 1),
(14, 'Registros Básicos', '', NULL, '', NULL, 2),
(15, 'Eventos', 'lista', NULL, '', NULL, 2),
(16, 'Reportes', '', NULL, '', NULL, 2),
(17, 'Sesión', '', NULL, '', NULL, 2),
(18, 'Usuario', 'registro1', 'usuario', 'registrar.UsuarioController', 1, 2),
(19, 'Registrar Evento', 'registro1', 'listaEventos', 'evento.EventoListaController', 15, 2),
(20, 'Registrar Lineamientos', 'registro1', 'listaEventosLineamientos', 'evento.EventoLineamientoListaController', 15, 2),
(21, 'Registrar Comisionados', 'registro1', 'listaEventosComisionados', 'evento.EventoComisionadoListaController', 15, 2),
(22, 'Cambio de clave', 'registro1', 'contrasena', 'registrar.ContrasenaController', 17, 2),
(23, 'Cerrar sesión', 'registro1', NULL, 'login.SalirController', 17, 2),
(24, 'Asignar Responsables', 'registro1', 'listaEventoResponsable', 'evento.EventoResponsableListaController', 15, 2),
(25, 'Registrar Reincidencias', 'registro1', 'listaEventosReincidencia', 'evento.EventoReincidenciaListaController', 15, 2),
(26, 'Listados', 'registro1', 'reportegen', 'reportes.Reportegeneral', 3, 2),
(27, 'Plan de Acción', 'plan', NULL, NULL, NULL, 2),
(28, 'Avances', '', NULL, NULL, NULL, 2),
(29, 'Registrar Actividad', 'registro1', 'listaActividad', 'actividad.ListaActividadController', 27, 2),
(30, 'Asignar Ejecutor', 'registro1', 'listaPlanEventoAsignarEjecutor', 'actividad.ListaPlanEventoAsignarEjecutorController', 27, 2),
(31, 'Evaluar Avances', 'registro1', 'listaAvanceFinal', 'avance.AvanceListaController', 28, 2),
(32, 'Consultar Avances', 'registro1', 'gridConsultarAvances', 'avance.AvanceListaController', 28, 2),
(33, 'Consultar Eventos', 'registro1', '', '', 3, 2),
(34, '', 'registro1', 'avance', 'avance.AvanceController', 15, 2),
(35, 'Registrar Avances ', 'registro1', 'gridListaAvance', 'avance.AvanceController', 28, 2),
(36, 'FUNCIONARIOS', '', NULL, NULL, NULL, 2),
(37, 'Registrar Usuario', 'registro1', 'usuario', 'registrar.UsuarioController', 36, 2),
(38, 'Registrar Empleado', 'registro1', 'empleado', 'registrar.EmpleadoController', 36, 2),
(39, 'Seguridad', '', NULL, NULL, NULL, 2),
(40, 'Configurar Permiso', 'registro1', 'permisoForm', 'seguridad.PermisoController', 39, 2);
...
(1, 15, 'No posee descripcion'),
(1, 17, 'No posee descripcion'),
(1, 19, 'No posee descripcion'),
(1, 20, 'No posee descripcion'),
(1, 21, 'No posee descripcion'),
(1, 22, 'No posee descripcion'),
(1, 23, 'No posee descripcion'),
(1, 24, 'No posee descripcion'),
(1, 25, 'No posee descripcion'),
(1, 36, 'No posee descripcion'),
(1, 37, 'No posee descripcion'),
(1, 38, 'No posee descripcion'),
(1, 39, 'No posee descripcion'),
(1, 40, 'No posee descripcion'),
(2, 1, 'No posee descripcion'),
(2, 2, 'No posee descripcion'),
(2, 3, 'No posee descripcion'),
(2, 4, 'No posee descripcion'),
(2, 5, 'No posee descripcion'),
(2, 6, 'No posee descripcion'),
(2, 8, 'No posee descripcion'),
(2, 9, 'No posee descripcion'),
(2, 10, 'No posee descripcion'),
(2, 11, 'No posee descripcion'),
(2, 13, 'No posee descripcion'),
(2, 17, 'No posee descripcion'),
(2, 22, 'No posee descripcion'),
(2, 23, 'No posee descripcion'),
(2, 27, 'No posee descripcion'),
(2, 28, 'No posee descripcion'),
(2, 29, 'No posee descripcion'),
(2, 30, 'No posee descripcion'),
(2, 31, 'No posee descripcion'),
(2, 32, 'No posee descripcion'),
(2, 35, 'No posee descripcion'),
(3, 17, 'No posee descripcion'),
(3, 22, 'No posee descripcion'),
(3, 23, 'No posee descripcion'),
(3, 28, 'No posee descripcion'),
(3, 35, 'No posee descripcion'),
...
(202020, 'V', 'JUAN', 'SALAS', '', 2147483647, 0, 'DFFD@WKJDIKSD.COM', '1990-09-25', 'S', '1', 2, '0481.jpg', 2, 8, 1),
...
(1279790, 'V', 'RAMON', 'CORONEL', 'El CUJI', 414111, NULL, 'gobernacion@gmail.com', '2015-04-07', 'S', 'M', 2, '6186.jpg', 2, 8, 1),
(2070711, 'V', 'DIDIO', 'MOSQUERA', 'El CUJI', 414111, NULL, 'gobernacion@gmail.com', '2015-04-07', 'S', 'M', 2, '3123123123', 2, 8, 1),
(2199259, 'V', 'MARCIAL', 'ESCALONA', 'El CUJI', 414111, NULL, 'gobernacion@gmail.com', '2015-04-07', 'S', 'M', 2, '3005.jpg', 2, 8, 1),
...
(3080841, 'V', 'IRAIDES', 'HERNANDEZ', 'El CUJI', 414111, NULL, 'gobernacion@gmail.com', '2015-04-07', 'S', 'M', 2, '1507.jpg', 2, 8, 1),
...
(3864630, 'V', 'CARMEN', 'RIVERO', 'El CUJI', 414111, NULL, 'gobernacion@gmail.com', '2015-04-07', 'S', 'M', 2, '0504.jpg', 2, 8, 1),
(3864789, 'V', 'ROSA', 'ALEJOS', 'El CUJI', 414111, NULL, 'gobernacion@gmail.com', '2015-04-07', 'S', 'M', 2, '2704.jpg\r\n', 2, 8, 1),
...
(23364399, 'V', 'JOSEFINA', 'ARROYO', 'El CUJI', 414111, NULL, 'gobernacion@gmail.com', '2015-04-07', 'S', 'M', 2, '0369.jpg', 2, 8, 1),
...
INSERT INTO `sistema` (`id`, `siglas`, `nombre`) VALUES
(1, 'SAGL', 'Sistema de Autorizacion de la Gobernacion del Estado Lara'),
(2, 'PREVENGO', 'Programa de Registro y Evaluacion de Eventos y Novedades para la Gestion Oportuna. Gobernacion de Lara');
...
`id` int(3) NOT NULL,
  ...
  `estatus` tinyint(1) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COMMENT='Usuario que hereda de persona';
...
(4, 'responsable 2', 1279790, 'v', 'e10adc3949ba59abbe56e057f20f883e', 2, NULL, NULL, 1),
(5, 'ejecutor2', 3080841, 'v', 'e10adc3949ba59abbe56e057f20f883e', 3, NULL, NULL, 1),
(6, 'ejecutor3', 2199259, 'v', 'e10adc3949ba59abbe56e057f20f883e', 3, NULL, NULL, 1),
(7, 'responsable3', 3864789, 'v', 'e10adc3949ba59abbe56e057f20f883e', 2, NULL, NULL, 1);
